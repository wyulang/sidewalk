      ...
      <div class="ar-10 kefu zi-8888 jb-fc ra-5 jb-bc pp5">
        <div class="w-130 pl10 pr10 ra-3 bc-f">
          ...
          <div class="flex w-all pt5 pb5 ai-c">
            ...
            <span @click="href('http://wpa.qq.com/msgrd?v=3&amp;uin=244179034&amp;site=qq&amp;menu=yes')" class="fc-666 hand">点击咨询</span>
          </div>
        ...
        <div class="w-130 pl10 pr10 mt10 ra-3 bc-f">
          <div class="bb-e w-all bd-color center pt10 fs-18 pb10">咨询热线</div>
          <div class="flex w-all pt10 pb5 ai-c">
            <span class="iconfont icondianhua mr5"></span>
            <span class="fc-666">400-189-0908</span>
          </div>
          <div class="flex w-all jc-c pb10 ai-c">
            <span class="center fc-666">0574-86578090</span>
          </div>
        </div>
        <div class="w-130 pl10 pr10 mt10 ra-3 bc-f">
          <div class="bb-e w-all bd-color center pt10 fs-18 pb10">QQ群</div>
          <div class="flex w-all pt10 pb5 ai-c">
            <span class="iconfont iconqq mr5"></span>
            <span class="fc-666">850950100<br/>(浙江总群)</span>
          </div>
          <div class="flex w-all jc-c pb10 ai-c">
            <span class="center fc-666">786199993<br/>(湖州群)</span>
          </div>
        </div>
      </div>
